...
public class GuiModProfiles
{
    ...
    private List<GuiModProfiles.BottomButtonType> bottomButtons = new ArrayList();
    ...
    private List<GuiModProfiles.BottomButtonType> confirmationBoxButtons = new ArrayList();
    ...
    private List<String> informationStrings = new ArrayList();
    ...
    public Pair<ModProfile, Boolean> isMouseOverModProfile(int mouseX, int mouseY)
    {
        int i = this.boxXOffset;
        ...
        if (mouseX >= l && mouseX < l + j && mouseY > i1 && mouseY < i1 + this.profileEntryHeight * this.numberOfProfilesPerPage)
        {
            ...
            if (j1 < Wrapper.getInstance().getModProfileManager().getModProfiles().size())
            {
                ...
                return Pair.<ModProfile, Boolean>of(modprofile, Boolean.valueOf(flag));
            }
            else
            {
                return null;
