...
public class SlidePage
{
    ...
    private List<SlideElementPage> pages = new ArrayList();
    private int width;
    private int height;
    ...
    public List<RenderElement> getAllElementList()
    {
    ...
    {
        return (List<RenderElement>)(this.page >= this.pages.size() ? (this.pages.size() == 0 ? new ArrayList() : ((SlideElementPage)this.pages.get(0)).getElementList()) : ((SlideElementPage)this.pages.get(this.page)).getElementList());
    }
