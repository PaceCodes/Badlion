...
public class SlideoutGUI
{
    ...
    private HashMap<String, SlidePage> pages = new HashMap();
    ...
    public void keyTyped(char character, int keyCode, Event event)
    {
        ...
        {
            int i = ((KeyBindElement)((KeyBindElement)((SlidePage)this.pages.get("slideoutSettings")).getElementList().get(2))).getKey();
    ...
    public void initPages()
    {
        ...
        for (Mod mod : Wrapper.getInstance().getActiveModProfile().getAllMods())
        {
            ...
            {
                LogManager.getLogger().info("ERROR Creating Menu: " + mod.getDisplayName() + " - " + exception.getMessage());
