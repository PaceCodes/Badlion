...
public class CapeManager
{
    ...
    private Map<UUID, Integer> userToCape = new ConcurrentHashMap();
    private Map<String, ResourceLocation> capeResources = new HashMap();
    ...
    public Map<UUID, Integer> getUserToCape()
    {
