...
import net.badlion.client.mods.render.Keystrokes;
...
public class ModProfile
{
    ...
    private Keystrokes keyStroke = new Keystrokes();
    ...
    private transient List<Mod> allMods;
    private transient Map<EventType, List<Mod>> registeredEvents;
    ...
    public void activate()
    {
        ...
        this.allMods.add(this.direction);
        ...
        for (Mod mod : this.allMods)
        {
            ...
            {
                LogManager.getLogger().info("ERROR LOADING MOD init(): " + mod.getDisplayName() + " - " + exception.getMessage());
    ...
    public Keystrokes getKeyStroke()
    {
    ...
    {
        Collections.sort(this.allMods, new Comparator<Mod>()
        {
