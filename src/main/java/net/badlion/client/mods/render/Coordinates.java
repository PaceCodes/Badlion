    ...
    public void onEvent(Event e)
    {
        ...
        if (e instanceof RenderGame && this.isEnabled())
        {
            ...
            else
            {
                ...
                s2 = String.format(s, new Object[] {Double.valueOf(this.gameInstance.thePlayer.renderArmYaw)});
            ...
            if (!this.useFancyFont.getValue().booleanValue())
            {
                ...
                switch (this.modOrientation)
                {
                    case VERTICAL:
                        ...
                        if (this.directionEnabled.isTrue())
                        {
                            Direction.Directions showdirection$direction1 = Direction.Directions.values()[MathHelper.floor_double((double)(this.gameInstance.thePlayer.rotationYaw * 4.0F / 180.0F) + 0.5D) & 7];
                            this.gameInstance.fontRendererObj.drawString(showdirection$direction1.name(), k5 - 8, currentY, this.primaryColor.getColorInt());

                            switch (showdirection$direction1)
                            {
                                case N:
                    ...
                    case HORIZONTAL:
                        ...
                        if (this.directionEnabled.isTrue())
                        {
                            Direction.Directions showdirection$direction = Direction.Directions.values()[MathHelper.floor_double((double)(this.gameInstance.thePlayer.rotationYaw * 4.0F / 180.0F) + 0.5D) & 7];
                            this.fontRenderer.drawString(showdirection$direction.name(), k5 - 10, j, this.primaryColor.getColorInt());
                            String s8 = "";
                            String s9 = "";

                            switch (showdirection$direction)
                            {
                                case N:
                                    s9 = "--";
                                    break;
            ...
            else
            {
                ...
                switch (this.modOrientation)
                {
                    case VERTICAL:
                        ...
                        if (this.directionEnabled.isTrue())
                        {
                            Direction.Directions showdirection$direction2 = Direction.Directions.values()[MathHelper.floor_double((double)(this.gameInstance.thePlayer.rotationYaw * 4.0F / 180.0F) + 0.5D) & 7];
                            ColorUtil.bindColor(this.primaryColor.getColor());
                            ...
                            switch (showdirection$direction2)
                            {
                                case N:
                    ...
                    case HORIZONTAL:
                        ...
                        {
                            ColorUtil.bindColor(this.primaryColor.getColor());
                            Direction.Directions showdirection$direction3 = Direction.Directions.values()[MathHelper.floor_double((double)(this.gameInstance.thePlayer.rotationYaw * 4.0F / 180.0F) + 0.5D) & 7];
                            ...
                            switch (showdirection$direction3)
                            {
                                case N:
                                    s14 = "--";
                                    break;
