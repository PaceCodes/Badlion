...
public class Direction extends RenderMod
{
    private ModColor textColor = new ModColor(-1);
    private ModColor backgroundColor = new ModColor(-1289213133);
    private net.badlion.client.mods.render.Direction.DirectionType directionType = net.badlion.client.mods.render.Direction.DirectionType.COMPASS;
    ...
    public void reset()
    {
        ...
        this.directionType = net.badlion.client.mods.render.Direction.DirectionType.COMPASS;
    ...
    public void createCogMenu()
    {
        ...
        if (this.directionType.equals(net.badlion.client.mods.render.Direction.DirectionType.COMPASS))
        {
        ...
        if (this.directionType == net.badlion.client.mods.render.Direction.DirectionType.SIMPLE)
        {
        ...
        this.slideCogMenu.addElement(this.typeDropdown = new Dropdown(new String[] {"Compass", "Simple"}, this.directionType.equals(net.badlion.client.mods.render.Direction.DirectionType.COMPASS) ? 0 : 1, 0.19D));
        this.textColor.init();
    ...
    public Direction()
    {
        super("Direction", 206, -126, 150, 18);
    ...
    public void init()
    {
        ...
        this.setDisplayName("Show Direction");
    ...
    public void onEvent(Event e)
    {
        ...
        {
            net.badlion.client.mods.render.Direction.DirectionType showdirection$directiontype = this.typeDropdown.getValue().equals("Compass") ? net.badlion.client.mods.render.Direction.DirectionType.COMPASS : net.badlion.client.mods.render.Direction.DirectionType.SIMPLE;
        ...
        if (e instanceof RenderGame && this.shouldDisplayDirection())
        {
            ...
            if (this.directionType.equals(net.badlion.client.mods.render.Direction.DirectionType.SIMPLE))
            {
                ...
                String s = net.badlion.client.mods.render.Direction.Directions.values()[MathHelper.floor_double((double)(this.gameInstance.thePlayer.rotationYaw * 4.0F / 180.0F) + 0.5D) & 7].name();
            ...
            else if (this.directionType.equals(net.badlion.client.mods.render.Direction.DirectionType.COMPASS))
            {
