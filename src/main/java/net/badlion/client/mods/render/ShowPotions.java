...
public class ShowPotions extends RenderMod
{
    ...
    public ShowPotions()
    {
        super("ShowPotions", 194, -115, 18, 28);
        this.iconDimension = new ImageDimension(78, 78);
        this.defaultTopLeftBox = new BoxedCoord(21, 30, 0.3333333333333333D, 0.7703703703703704D);
        this.defaultCenterBox = new BoxedCoord(21, 31, 0.6666666666666666D, 0.6814814814814815D);
        this.defaultBottomRightBox = new BoxedCoord(22, 32, 0.0D, 0.6222222222222222D);
    }

    public void init()
    {
        this.setDisplayName("Show Potions");
    ...
    public void onEvent(Event e)
    {
        ...
        if (e instanceof RenderGame && this.isEnabled())
        {
            ...
            int i = Wrapper.getInstance().getActiveModProfile().getModConfigurator().isInEditingMode() ? 64 : this.getRemainingPotions();
            int j = 2;
            int k = 0;
            int l = 0;
            this.beginRender();
            ...
            this.gameInstance.getRenderItem().renderItemIntoGUI(new ItemStack(Items.potionitem), k + 1, l);
    ...
    private int getRemainingPotions()
    {
        int i = 0;
