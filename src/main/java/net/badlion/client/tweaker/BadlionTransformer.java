...
public class BadlionTransformer implements IClassTransformer
{
    ...
    public class TextureAtlasSpriteVisitor extends ClassVisitor
    {
        ...
        public MethodVisitor visitMethod(int access, String name, String desc, String signature, String[] exceptions)
        {
            ...
            return (MethodVisitor)(name.equals("a") && desc.equals("([[IIII)[[I") ? BadlionTransformer.this.new TextureAltasMethodVisitor(this.api, methodvisitor) : methodvisitor);
        }
    }
    ...
    public class TextureMapVisitor extends ClassVisitor
    {
        ...
        {
            MethodVisitor methodvisitor = super.visitMethod(access, name, desc, signature, exceptions);
            return (MethodVisitor)(name.equals("b") && desc.equals("(Lbni;)V") ? BadlionTransformer.this.new TextureMapVisitorMethodVisitor(this.api, methodvisitor) : methodvisitor);
        }
    }
