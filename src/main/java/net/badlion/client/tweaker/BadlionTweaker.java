...
public class BadlionTweaker implements ITweaker
{
    ...
    public void acceptOptions(List<String> args, File gameDir, File assetsDir, String profile)
    {
        ...
        catch (InvocationTargetException | IllegalAccessException | NoSuchMethodException nosuchmethodexception)
            {
    ...
    public String[] getLaunchArguments()
    {
        ...
        return (String[])((String[])this.args.toArray(new String[this.args.size()]));
    }
