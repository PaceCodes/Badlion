...
public class EntityPlayerSP extends AbstractClientPlayer
{
    ...
    public void onUpdate()
    {
        ...
        {
            super.onUpdate();
            MotionUpdate motionupdate = new MotionUpdate(this.posX, this.renderArmYaw, this.posY, this.posZ, this.rotationYaw, this.rotationPitch, this.onGround);
            Wrapper.getInstance().getActiveModProfile().passEvent(motionupdate);
