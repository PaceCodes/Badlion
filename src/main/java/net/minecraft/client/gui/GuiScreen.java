...
public abstract class GuiScreen extends Gui implements GuiYesNoCallback
{
    ...
    {
        GUIKeyPress guikeypress = new GUIKeyPress(typedChar, keyCode);
        Wrapper.getInstance().getActiveModProfile().passEvent(guikeypress);
    ...
    {
        GUIClickMouse guiclickmouse = new GUIClickMouse(mouseButton);
        Wrapper.getInstance().getActiveModProfile().passEvent(guiclickmouse);
