...
public class BlockModelRenderer
{
    ...
    {
        if (!Wrapper.getInstance().isClearGlass() || blockIn != Blocks.glass && blockIn != Blocks.glass_pane)
        {
            boolean flag = false;
            BitSet bitset = new BitSet(3);
    ...
    class AmbientOcclusionFace
    {
        ...
        public void updateVertexBrightness(IBlockAccess blockAccessIn, Block blockIn, BlockPos blockPosIn, EnumFacing facingIn, float[] quadBounds, BitSet boundsFlags)
        {
            ...
            else
            {
                ...
                f26 = blockAccessIn.getBlockState(blockpos6).getBlock().getAmbientOcclusionLightValue();
            ...
            else
            {
                ...
                f27 = blockAccessIn.getBlockState(blockpos7).getBlock().getAmbientOcclusionLightValue();
            ...
            else
            {
                ...
                f28 = blockAccessIn.getBlockState(blockpos8).getBlock().getAmbientOcclusionLightValue();
