...
public class RenderGlobal implements IWorldAccess, IResourceManagerReloadListener
{
    ...
    public void renderSky(float partialTicks, int pass)
    {
        ...
        else if (this.mc.theWorld.provider.isSurfaceWorld())
        {
            ...
            GlStateManager.pushMatrix();
            float f19 = 1.0F - this.theWorld.getRainStrength(partialTicks);
            GlStateManager.color(1.0F, 1.0F, 1.0F, f19);
            GlStateManager.rotate(-90.0F, 0.0F, 1.0F, 0.0F);
            GlStateManager.rotate(this.theWorld.getCelestialAngle(partialTicks) * 360.0F, 1.0F, 0.0F, 0.0F);
            float f20 = 30.0F;
            this.renderEngine.bindTexture(locationSunPng);
            worldrenderer.begin(7, DefaultVertexFormats.POSITION_TEX);
            worldrenderer.pos((double)(-f20), 100.0D, (double)(-f20)).tex(0.0D, 0.0D).endVertex();
            worldrenderer.pos((double)f20, 100.0D, (double)(-f20)).tex(1.0D, 0.0D).endVertex();
            worldrenderer.pos((double)f20, 100.0D, (double)f20).tex(1.0D, 1.0D).endVertex();
            worldrenderer.pos((double)(-f20), 100.0D, (double)f20).tex(0.0D, 1.0D).endVertex();
            tessellator.draw();
            f20 = 20.0F;
            ...
            worldrenderer.begin(7, DefaultVertexFormats.POSITION_TEX);
            worldrenderer.pos((double)(-f20), -100.0D, (double)f20).tex((double)f24, (double)f14).endVertex();
            worldrenderer.pos((double)f20, -100.0D, (double)f20).tex((double)f22, (double)f14).endVertex();
            worldrenderer.pos((double)f20, -100.0D, (double)(-f20)).tex((double)f22, (double)f23).endVertex();
            worldrenderer.pos((double)(-f20), -100.0D, (double)(-f20)).tex((double)f24, (double)f23).endVertex();
            tessellator.draw();
            GlStateManager.disableTexture2D();
            float f15 = this.theWorld.getStarBrightness(partialTicks) * f19;
            ...
            if (d0 < 0.0D)
            {
                ...
                GlStateManager.popMatrix();
                float f16 = 1.0F;
                float f17 = -((float)(d0 + 65.0D));
                float f18 = -1.0F;
                worldrenderer.begin(7, DefaultVertexFormats.POSITION_COLOR);
                worldrenderer.pos(-1.0D, (double)f17, 1.0D).color(0, 0, 0, 255).endVertex();
                worldrenderer.pos(1.0D, (double)f17, 1.0D).color(0, 0, 0, 255).endVertex();
    ...
    {
        BlockOverlay.drawSelectionBox(player, movingObjectPositionIn, p_72731_3_, partialTicks);
    }
