...
public class WorldRenderer
{
    ...
    public void setColorRGBA_I(int p_setColorRGBA_I_1_, int p_setColorRGBA_I_2_)
    {
        int i = p_setColorRGBA_I_1_ >> 16 & 255;
        int j = p_setColorRGBA_I_1_ >> 8 & 255;
        int k = p_setColorRGBA_I_1_ & 255;
        this.putColorRGB_F((float)i, (float)j, (float)k, p_setColorRGBA_I_2_);
    }
